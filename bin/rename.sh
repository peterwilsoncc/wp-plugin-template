...
sed -i '' "s/${OLD_NAME}/${NEW_NAME}/g" *.* inc/*.* tests/tests/*.* tests/*.*
# Camel case replacements
sed -i '' "s/${OLD_CAMEL_CASE_NAME}/${CAMEL_CASE_NAME}/g" *.* inc/*.* tests/tests/*.* tests/*.*
# Kebab case replacements
sed -i '' "s/${OLD_KEBAB_CASE_NAME}/${KEBAB_CASE_NAME}/g" *.* inc/*.* tests/tests/*.* tests/*.*
